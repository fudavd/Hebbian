...
from src.prototypical import MetaProto
from src.networks import ConvNet
from src.utils import TrainingLogger, get_dataset, split_dataset_by_class, select_class_set
...
def main():
    ...
    for rep in range(config['repetitions']):
        ...
        logger = TrainingLogger(
            log_dir=F"./results/{config['dataset']}/Proto/N-{config['n_classes']}:K-{config['n_shots']}/{rep}",
