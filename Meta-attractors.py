import argparse
from src.Hebbian import MetaHebbian
...
def main():
    ...
    # Best config is  ([(28, 28), (64, 3), (64, 3), (64, 3), (64, 3)], 0.01, 0.001, 10): 10 = 98.711; 5 = 97.917 1 = 97.917
    config = {
        'n_classes': 5,
        'n_shots': shots,
        'n_query': 15,
    ...
    logger = TrainingLogger(
        log_dir=F"./results/{config['dataset']}/IPA/N-{config['n_classes']}:K-{config['n_shots']}/{rep}",
